...
import type { VendorProfile, WeddingProject, GoogleBusinessData, GoogleBusinessReview } from "@/types/marketplace";
...
export default function VendorProfileForCouplePage() {
  ...
  const isVerified = Boolean(vendor.verified || vendor.status === "approved");
        ...
        <div className="lg:sticky lg:top-8">
          <div className="relative rounded-[28px] bg-white border border-[#d8d0f5] shadow-[0_18px_44px_rgba(11,15,26,0.08)] overflow-hidden">
            ...
            <div className="px-6 pt-6 pb-5">
              ...
              <div className="flex items-center gap-2 sm:gap-2.5 pb-5 mb-5 border-b border-dashed border-[#0E0E10]/15 text-xs sm:text-[13px] text-[#0E0E10]/80 whitespace-nowrap">
                <span className="flex items-center gap-1 text-[#0E0E10] font-medium shrink-0">
                ...
                <span className="w-px h-3 bg-black/15 shrink-0" />
                <span className="flex items-center gap-1 shrink-0" title={location}>
                  ...
                  <>
                    ...
                    {vendor.portfolio.googleBusiness.placeUrl ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1 text-[#0E0E10] hover:underline font-medium shrink-0 transition"
                      ...
                      <span className="inline-flex items-center gap-1 text-[#0E0E10] font-medium shrink-0">
                        <GoogleIcon className="w-3.5 h-3.5" />
                        <span>Avis Maps</span>
                      </span>
                    )}
              ...
              <div className="space-y-2.5 mb-2">
                ...
                <LedgerRow
                  label="Vérification"
                  value={isVerified ? "Vérifié" : "En cours"}
                  success={isVerified}
                />
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex gap-3">
                    ...
                    {vendor.phone ? (
                      <a href={`tel:${vendor.phone.replace(/\s+/g, "")}`} className="text-[#0E0E10] hover:underline">
                        {vendor.phone}
                      </a>
                    ) : (
                      <span className="text-[#0E0E10]">Non renseigné</span>
                    )}
                  </div>
                  <div className="flex gap-3">
                    <span className="font-semibold text-[10px] text-[#0E0E10]/70 w-10 shrink-0 pt-0.5">
                    ...
                    {vendor.email ? (
                      <a href={`mailto:${vendor.email}`} className="text-[#0E0E10] hover:underline break-all">
                        {vendor.email}
                      </a>
                    ) : (
                      <span className="text-[#0E0E10] break-all">Non renseigné</span>
                    )}
                  </div>
                  {website && (
                    <div className="flex gap-3">
                ...
                {allReviews.map((review, i) => (
                  <div key={i} className="rounded-xl bg-white border border-[#EDEDF0] p-5">
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="h-8 w-8 rounded-full bg-[#fef2f4] border border-[#EDEDF0] flex items-center justify-center shrink-0">
                        {review.source === "google" ? (
                          <GoogleIcon className="w-4 h-4" />
                        ) : (
                          <span className="text-[#0E0E10] font-semibold text-xs">
                            {(review.author || "C").slice(0, 1).toUpperCase()}
                          </span>
                        )}
                      </div>
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5">
                          <span className="font-medium text-[#0E0E10] text-sm truncate">{review.author || "Client"}</span>
                          {review.source === "google" && (
