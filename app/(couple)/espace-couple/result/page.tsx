...
export default function CoupleResultPage() {
 ...
 if (loading) return <div className="min-h-[100dvh] bg-[#fff0f3]" />;
 if (error) return <div className="min-h-[100dvh] p-6">{error}</div>;
 if (!session?.aiOutput) return <div className="min-h-[100dvh] p-6">Résultat indisponible.</div>;
 ...
 <div className="absolute left-4 right-4 sm:left-6 sm:right-6 -bottom-12 rounded-[24px] bg-white p-4 sm:p-5 z-20">
 ...
 <div className="absolute -top-6 left-4 sm:-top-8 sm:-left-6 bg-white rounded-[22px] p-4 w-[160px] sm:w-[190px] z-10">
 ...
 <div className="absolute top-6 right-4 sm:top-10 sm:-right-7 bg-lavender rounded-[22px] p-4 w-[160px] sm:w-[190px] z-10">
 <div className="flex items-center gap-2 mb-2">
 ...
 {/* ============================== HERO ============================== */}
 <section className="px-6 pt-10 pb-14 lg:pt-12 lg:pb-16 bg-[#fff0f3]">
 <div className="max-w-6xl mx-auto">
 <div className="grid lg:grid-cols-[1.05fr_.95fr] gap-12 lg:gap-16 items-center">
 <div className="text-center lg:text-left">
 <span className="inline-flex items-center h-[26px] px-3.5 rounded-full text-[11px] font-semibold uppercase tracking-[0.04em] text-grey bg-white mb-5">
 ...
 className="inline-flex items-center gap-2 h-10 px-4 rounded-full bg-white text-sm font-semibold text-text-secondary hover:text-text-primary hover:bg-black/[0.02] transition"
 >
 ...
 <div className="rounded-[20px] bg-white p-6 flex items-center justify-center gap-8 text-sm font-medium text-ink flex-wrap">
 ...
 {/* Risk gauge panel */}
 <div className="rounded-[20px] bg-white p-6 sm:p-8 min-h-[340px] relative mt-4">
 <div className="flex items-start justify-between mb-2">
 <div className="text-lg font-bold" style={{ color: riskTone }}>
 Niveau de maîtrise
 </div>
 <button className="w-8 h-8 rounded-[10px] bg-white flex items-center justify-center text-ink font-bold text-sm tracking-widest">
 •••
 </button>
 </div>
 ...
 <span key={item} className="inline-flex h-8 items-center px-4 rounded-full bg-white text-sm font-semibold text-text-secondary">
 {item}
 </span>
 ))}
 </div>
 ...
 <span className="h-12 w-12 rounded-full " style={{ backgroundColor: c.hex }} />
 ...
 <div className="rounded-[32px] bg-ink text-white overflow-hidden ">
 ...
 className={`absolute left-2 top-[24px] z-20 h-5 w-5 rounded-full bg-yellow text-ink flex items-center justify-center transition ${canScroll.left ? "opacity-100" : "opacity-0 pointer-events-none"}`}
 ...
 type="button"
 onClick={() => scrollTimeline(1)}
 className={`absolute right-2 top-[24px] z-20 h-5 w-5 rounded-full bg-yellow text-ink flex items-center justify-center transition ${canScroll.right ? "opacity-100" : "opacity-0 pointer-events-none"}`}
 ...
 const bg = ["#88b7b5", "#E4DBFB", "#FBE1E6", "#F4D93E", "#F2704A"][idx % 5];
 return (
 <div
 ...
 <div className="flex-1 min-h-0 w-full rounded-[22px] bg-white/[0.06] p-4">
 ...
 <section className="px-6 py-16">
 <div className="max-w-6xl mx-auto">
 <div className="bg-white rounded-[28px] p-6 lg:p-12 ">
 ...
 .sort((a, b) => b[1] - a[1])
 .map(([k, v]) => (
 <div key={k} className="flex items-center justify-between gap-3 bg-white rounded-2xl px-5 py-4 ">
 ...
 <div>
 <span className="inline-flex items-center h-[26px] px-3.5 rounded-full bg-white/65 text-[11px] font-semibold uppercase tracking-[0.04em] text-grey mb-5">
 Matching
 </span>
 ...
 <div className="absolute left-0 top-1/2 -translate-y-1/2 bg-white rounded-[20px] p-4 w-[140px]">
 <div className="flex items-center gap-2 mb-2">
 ...
 <div className="absolute right-0 top-4 bg-yellow rounded-[20px] p-4 w-[140px]">
 <div className="flex items-center gap-2 mb-2">
 ...
 const Icon = col.icon;
 return (
 <div key={col.label} className="bg-white rounded-[20px] p-5 ">
 ...
 <span className="inline-flex items-center gap-2 h-12 px-6 rounded-full text-white text-sm font-semibold hover:bg-white/10 transition">
 Ajuster mon budget
 </span>
 </Link>
 </div>
