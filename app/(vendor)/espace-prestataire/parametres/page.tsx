      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="rounded-[32px] bg-white border border-[#e6e4dd] shadow-[0_40px_120px_rgba(14,14,16,0.18)] p-6 sm:p-8">
          <div className="flex items-center gap-2.5 mb-5">
            <div className="h-9 w-9 rounded-full bg-[#dff05a] flex items-center justify-center text-[#1c1c1c]">
              <Bell size={18} />
            </div>
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between">
              ...
              <input
                ...
                className="h-5 w-5 accent-[#dff05a]"
              />
            </label>
            <label className="flex items-center justify-between">
        ...
        <div className="rounded-[32px] bg-white border border-[#e6e4dd] shadow-[0_40px_120px_rgba(14,14,16,0.18)] p-6 sm:p-8">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full rounded-xl border border-[#e6e4dd] px-4 py-3 text-sm bg-white text-[#1c1c1c] placeholder:text-[#8b8b86] focus:outline-none focus:ring-2 focus:ring-[#dff05a]"
            />
            <input
              type="password"
              value={newPassword}
