...
async function run() {
  ...
  console.log("Vendor full:", JSON.stringify(vendor, null, 2));
  console.log("Project full:", JSON.stringify(project, null, 2));

  // Let's test findTopMatches with console logging
